...
;noyax top
			...
			If ($iCmbTSSearchMode = 0 AND NOT $dbBase) Then
				setlog("Not a dead base")
				$resultTHsn = False ;Not a base match
			ElseIf ($iCmbTSSearchMode = 1 AND $dbBase) Then
				setlog("Not a live base")
				$resultTHsn = False ;Not a base match
			EndIf;
